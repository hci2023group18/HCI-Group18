...
function showLogin() {
  ...
  document.getElementById('navbar-login-link').style.display = 'none'; 
  document.getElementById('navbar-user-link').style.display = 'block'; 
...
function showRegister() {
  ...
  document.getElementById('navbar-login-link').style.display = 'block';
  document.getElementById('navbar-user-link').style.display = 'none'; 
